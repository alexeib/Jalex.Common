...
namespace Jalex.Infrastructure.ReflectedTypeDescriptor
{
    internal class ReflectedTypeDescriptor<T> : IReflectedTypeDescriptor<T>
    {
        ...
        public Expression<Func<T, Guid>> IdGetterExpression { get; private set; }
        ...
        public ReflectedTypeDescriptor()
        {
            ...
            IdGetterExpression = ExpressionUtils.GetPropertyGetterExpression<T, Guid>(IdPropertyName);
            _idGetter = IdGetterExpression.Compile();
            _idSetter = ExpressionUtils.GetPropertySetter<T, Guid>(IdPropertyName);
        ...
        public void SetId(T target, Guid id)
        {
            _idSetter(target, id);
        }
        ...
        {
            return ExpressionUtils.GetExpressionForPropertyEquality<T, Guid>(id, IdPropertyExpression, TypeParameter);
        }
        ...
        private static string getIdPropertyName(IEnumerable<PropertyInfo> classProps, out bool isAutoGenerated)
        {
            ...
            {
                throw new RepositoryException("Id property " + idPropertyName + " must be of type Guid");
            }
