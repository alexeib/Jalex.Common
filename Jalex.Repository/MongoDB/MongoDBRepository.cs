...
namespace Jalex.Repository.MongoDB
{
    public class MongoDBRepository<T> : BaseMongoDBRepository, IRepository<T>
    {
        ...
        static MongoDBRepository()
        {
            ...
            var classProps = typeOfT.GetProperties(BindingFlags.Instance | BindingFlags.Public);
            ...
            var ignoredPropertyNames = getIgnoredPropertyNames(classProps);
            var ignoredPropGetters = ignoredPropertyNames.Select(ExpressionProperties.GetPropertyGetterExpression<T, string>);
        ...
        private static void registerClassMap(string idPropertyName, bool isIdAutoGenerated, IEnumerable<Expression<Func<T, string>>> ignoredPropGetters )
        {
