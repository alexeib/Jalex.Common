...
namespace Jalex.Repository.Cassandra.DataStax.Linq
{
    ...
    public class Table<TEntity> : Jalex.Repository.Cassandra.DataStax.Linq.CqlQuery<TEntity>, ITable, IQueryProvider
    {
        ...
        {
            return new Jalex.Repository.Cassandra.DataStax.Linq.CqlQuery<TElement>(expression, this);
        }
        ...
        public Jalex.Repository.Cassandra.DataStax.Linq.CqlInsert<TEntity> Insert(TEntity entity)
        {
            return new Jalex.Repository.Cassandra.DataStax.Linq.CqlInsert<TEntity>(entity,this);
        }
