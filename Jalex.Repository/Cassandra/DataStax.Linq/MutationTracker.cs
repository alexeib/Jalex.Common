...
namespace Jalex.Repository.Cassandra.DataStax.Linq
{
    ...
    {
        void SaveChangesOneByOne(Jalex.Repository.Cassandra.DataStax.Linq.Context context, string tablename, ConsistencyLevel consistencyLevel);
    ...
    internal class MutationTracker<TEntity> : IMutationTracker
    {
        ...
        public void SaveChangesOneByOne(Jalex.Repository.Cassandra.DataStax.Linq.Context context, string tablename, ConsistencyLevel consistencyLevel)
        {
