...
namespace Jalex.Repository.Cassandra.DataStax.Linq
{
    public static class SessionExtensions
    {
        ...
        public static Jalex.Repository.Cassandra.DataStax.Linq.Batch CreateBatch(this Session @this)
        {
            return new Jalex.Repository.Cassandra.DataStax.Linq.Batch(@this);
        }
    }
}
